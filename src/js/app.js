...
App = {
  ...
  init: async function () {
    ...
    this.accounts = [
      visionWeb.address.fromPrivateKey(metacoinConfig.privateKey)
    ]
  ...
  getContract: function (address, callback) {
    visionWeb.getContract(address).then(function (res) {
      callback && callback(res);
    });
  },
  triggerContract: async function (methodName, args, callback) {
    let myContract = await visionWeb.contract().at(this.contractAddress)
